...
#myDrone.takeoff()
#time.sleep(1)
#myDrone.send_rc_control(0, 0, 15, 0)
#time.sleep(1)


#cap = cv2.VideoCapture(0)

vidcap = cv2.VideoCapture("C:\\Users\\DST\\Desktop\\Autonomous_Tello_Drone-master\\pose_controlled_tello\\my_poses\\test3.mp4")
